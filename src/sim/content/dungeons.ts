...
export const DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  crypt_shambler: {
    id: 'crypt_shambler', name: 'Crypt Shambler', minLevel: 7, maxLevel: 8, type: 'undead', elite: true,
  ...
  hollow_acolyte: {
    id: 'hollow_acolyte', name: 'Hollow Acolyte', minLevel: 8, maxLevel: 8, type: 'undead', elite: true,
  ...
  bonechill_widow: {
    id: 'bonechill_widow', name: 'Bonechill Widow', minLevel: 8, maxLevel: 9, type: 'spider', elite: true,
  ...
  sexton_marrow: {
    id: 'sexton_marrow', name: 'Sexton Marrow', minLevel: 9, maxLevel: 9, type: 'undead', elite: true,
  ...
  morthen: {
    id: 'morthen', name: 'Morthen the Gravecaller', minLevel: 10, maxLevel: 10, type: 'undead',
  ...
  bastion_revenant: {
    id: 'bastion_revenant', name: 'Bastion Revenant', minLevel: 12, maxLevel: 13, type: 'undead', elite: true,
  ...
  tidebound_acolyte: {
    id: 'tidebound_acolyte', name: 'Tidebound Acolyte', minLevel: 12, maxLevel: 13, type: 'humanoid', elite: true,
  ...
  drowned_thrall: {
    id: 'drowned_thrall', name: 'Drowned Thrall', minLevel: 11, maxLevel: 11, type: 'undead',
  ...
  knight_commander_olen: {
    id: 'knight_commander_olen', name: 'Knight-Commander Olen', minLevel: 13, maxLevel: 13, type: 'undead', elite: true,
  ...
  vael_the_mistcaller: {
    id: 'vael_the_mistcaller', name: 'Vael the Mistcaller', minLevel: 13, maxLevel: 13, type: 'humanoid',
    elite: true, boss: true,
  ...
  sanctum_boneguard: {
    id: 'sanctum_boneguard', name: 'Sanctum Boneguard', minLevel: 19, maxLevel: 19, type: 'undead', elite: true,
  ...
  sanctum_drakonid: {
    id: 'sanctum_drakonid', name: 'Sanctum Drakonid', minLevel: 19, maxLevel: 20, type: 'dragonkin', elite: true,
  ...
  raised_bonewalker: {
    id: 'raised_bonewalker', name: 'Raised Bonewalker', minLevel: 18, maxLevel: 18, type: 'undead',
  ...
  korgath_the_bound: {
    id: 'korgath_the_bound', name: 'Korgath the Bound', minLevel: 20, maxLevel: 20, type: 'ogre', elite: true,
  ...
  grand_necromancer_velkhar: {
    id: 'grand_necromancer_velkhar', name: 'Grand Necromancer Velkhar', minLevel: 20, maxLevel: 20, type: 'humanoid', elite: true,
  ...
  korzul_the_gravewyrm: {
    id: 'korzul_the_gravewyrm', name: 'Korzul the Gravewyrm', minLevel: 20, maxLevel: 20, type: 'dragonkin',
    elite: true, boss: true,
  ...
  nythraxis_skeleton_warrior: {
    id: 'nythraxis_skeleton_warrior', name: 'Risen Royal Guard', minLevel: 20, maxLevel: 20, type: 'undead',
  ...
  nythraxis_scourge_of_thornpeak: {
    id: 'nythraxis_scourge_of_thornpeak', name: 'Nythraxis, Scourge of Thornpeak', minLevel: 20, maxLevel: 20, type: 'undead',
