...
export const TEMPLE_MOBS: Record<string, MobTemplate> = {
  glimmermere_wader: {
    id: 'glimmermere_wader', name: 'Glimmermere Wader', minLevel: 15, maxLevel: 16, type: 'murloc',
  ...
  drowned_votary: {
    id: 'drowned_votary', name: 'Drowned Votary', minLevel: 15, maxLevel: 16, type: 'undead',
  ...
  sethrael_palecoil: {
    id: 'sethrael_palecoil', name: 'Sethrael the Palecoil', minLevel: 16, maxLevel: 16, type: 'dragonkin', rare: true,
...
export const TEMPLE_DUNGEON_MOBS: Record<string, MobTemplate> = {
  drowned_templeguard: {
    id: 'drowned_templeguard', name: 'Drowned Templeguard', minLevel: 16, maxLevel: 17, type: 'undead', elite: true,
  ...
  pale_choir_acolyte: {
    id: 'pale_choir_acolyte', name: 'Pale Choir Acolyte', minLevel: 16, maxLevel: 17, type: 'humanoid', elite: true,
  ...
  glimmerscale_lurker: {
    id: 'glimmerscale_lurker', name: 'Glimmerscale Lurker', minLevel: 16, maxLevel: 17, type: 'spider', elite: true,
  ...
  pearlguard_sentinel: {
    id: 'pearlguard_sentinel', name: 'Pearlguard Sentinel', minLevel: 17, maxLevel: 18, type: 'elemental', elite: true,
  ...
  choirmother_selthe: {
    id: 'choirmother_selthe', name: 'Choirmother Selthe', minLevel: 18, maxLevel: 18, type: 'humanoid', elite: true,
  ...
  moonspawn: {
    id: 'moonspawn', name: 'Moonspawn', minLevel: 16, maxLevel: 16, type: 'murloc',
  ...
  ysolei: {
    id: 'ysolei', name: 'Ysolei, Avatar of the Drowned Moon', minLevel: 18, maxLevel: 18, type: 'dragonkin',
