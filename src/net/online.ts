...
function blankEntity(id: number): Entity {
  return {
    ...
    threat: new Map(), forcedTargetId: null, forcedTargetTimer: 0, ownerId: null, allegiance: null, petMode: 'defensive', petTauntTimer: 0,
    spawnPos: { x: 0, y: 0, z: 0 }, leashAnchor: null, pursuitStallTimer: 0, evadeStall: 0, fleeTimer: 0, fleeReturnTimer: 0, hasFled: false, wanderTarget: null, wanderTimer: 0,
